...
public class Spawner : MonoBehaviour
{
    ...
    {
        Vector2 newPos = new Vector2(Random.Range(-GameManager.Single.RightUpperCorner.x - 1, GameManager.Single.RightUpperCorner.x + 1),
            Random.value > 0.5f ? -GameManager.Single.RightUpperCorner.y - 1 : GameManager.Single.RightUpperCorner.y + 1);
        return newPos;
    }
}
